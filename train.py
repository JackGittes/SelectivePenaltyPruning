...
from prune.layer import PruneBatchNorm, PruneInvertedResidual, penalty_loss
...
parser.add_argument('--resume', default='weight/mobilenet_v2.pth', type=str, metavar='PATH',
...
save_folder = '/home/ubuntu/MyFiles/PruneMobileNetV2Params'
